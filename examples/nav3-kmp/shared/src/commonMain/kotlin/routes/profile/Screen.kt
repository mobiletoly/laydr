...
import dev.goquick.laydr.examples.nav3kmp.accent
import dev.goquick.laydr.examples.nav3kmp.border
import dev.goquick.laydr.examples.nav3kmp.generated.LaydrRoutes
import dev.goquick.laydr.examples.nav3kmp.selectedBackground
import dev.goquick.laydr.examples.nav3kmp.surface
import dev.goquick.laydr.examples.nav3kmp.surfaceMuted
import dev.goquick.laydr.examples.nav3kmp.textMuted
import dev.goquick.laydr.examples.nav3kmp.textPrimary
...
private fun ProfileContent(routePath: String) {
    Column(
        ...
        ProfileSection(title = "Navigation Preferences") {
            ...
            DetailRow(label = "Saved view", value = "Responsive address book")
            DetailRow(label = "Route source", value = "routes/profile")
        }
    }
}
