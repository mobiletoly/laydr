...
/**
 * App-owned launch data for one Laydr AndroidX Nav3 entry.
 */
public typealias LaydrNavLaunch = dev.goquick.laydr.nav.runtime.LaydrNavLaunch

/**
 * App-owned metadata attached to one resolved Laydr AndroidX Nav3 entry.
 */
public typealias LaydrNavEntryMetadata = dev.goquick.laydr.nav.runtime.LaydrNavEntryMetadata

/**
 * Typed app-owned key for one value stored in Laydr AndroidX Nav3 entry
 * metadata.
 */
...
/**
 * Reason an AndroidX Nav3 key could not be rendered by Laydr.
 */
...
/**
 * Reads the value for [key] from a raw AndroidX Nav3 metadata map when it has
