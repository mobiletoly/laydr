...
/**
 * Route-facing capability for navigation inside declared Laydr AndroidX Nav3
 * sections.
 */
public interface LaydrNavSectionsNavigator {
    ...
    /**
     * Replaces the current entry with [launch].
     */
    ...
    /**
     * Replaces with [launch] and records the current selected stack as the next
     * app Back return point.
     */
