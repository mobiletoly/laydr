...
/**
 * Returns the current Laydr AndroidX Nav3 route launch payload when it exists
 * and has type [T].
 */
@Composable
...
/**
 * Returns the current Laydr AndroidX Nav3 route launch payload with type [T].
 */
@Composable
...
/**
 * One-shot route result sink for the current Laydr AndroidX Nav3 stack entry.
 */
...
/**
 * Returns the current Laydr AndroidX Nav3 route result sink when one exists
 * and has type [Result].
 */
@Composable
...
/**
 * Returns the current Laydr AndroidX Nav3 route result sink with type [Result].
 */
@Composable
...
internal class LaydrNavEntryStore(
    ...
    internal fun lookupPayload(key: LaydrNavKey): LaydrNavPayloadLookup {
    ...
    internal fun lookupResult(key: LaydrNavKey): LaydrNavResultLookup {
